...
a("#toggle-reward-qr-code").off("click").on("click",function(b){a("body").removeClass("show-post-qr-box").toggleClass("show-reward-qr-box")})};e.Mirages={setupPage:function(){U();Y();ca();X()},setupLazyLoadImage:function(){S()},setupCDNImageOptimize:function(){T()},version:function(){console.log("Mirages.version = "+LocalConst.THEME_VERSION);console.log("Mirages.js.version = 7.10.2.DEV1(20200620A)")},highlightCodeBlock:function(){Z()},renderFlowChart:function(){aa()},renderMermaid:function(){ba()},
doPJAXClickAction:function(){sa();a("body").attr("data-prev-href",g.location.pathname+g.location.search+g.location.hash).removeClass("display-menu-tree");a("#wrap").removeClass("display-menu-tree");LocalConst.PJAX_LOAD_STYLE===LocalConst.PJAX_LOAD_STYLE_SIMPLE&&a(".sp-progress").css("opacity","1")},doPJAXSendAction:function(){LocalConst.PJAX_LOAD_STYLE!==LocalConst.PJAX_LOAD_STYLE_SIMPLE&&LocalConst.PJAX_LOAD_STYLE===LocalConst.PJAX_LOAD_STYLE_CIRCLE&&a("#loader-wrapper").addClass("in");a("#wrap").removeClass("display-nav").removeClass("display-menu-tree");
